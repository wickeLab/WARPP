import { toggleFilterOptions } from "./filter_index"
import { update, root } from "./d3_tree"

export var containerElement = d3.select(".accordion-container");
...
export function updateAccordion(data) {
